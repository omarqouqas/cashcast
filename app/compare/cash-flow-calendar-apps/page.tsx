...
const comparisonRows = [
  ...
  { feature: 'Auto-detect recurring', cff: '✅ Import creates recurring entries', typical: '❌ Manual setup' },
  { feature: 'Reports & Export', cff: '✅ Monthly Summary, Category, Excel/JSON', typical: '⚠️ CSV only' },
