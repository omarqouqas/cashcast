...
const comparisonRows = [
  ...
  { feature: 'Credit card forecasting', cff: '✅ Utilization tracking + payment simulator', ynab: '❌ No' },
  { feature: 'Debt payoff planner', cff: '✅ Snowball vs Avalanche comparison', ynab: '❌ No' },
