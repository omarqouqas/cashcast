      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1, justifyContent: 'center' }}>
            <div style={{ fontSize: 56, fontWeight: 700, lineHeight: 1.15, letterSpacing: -1, maxWidth: 1000 }}>
              {post.title}
            </div>
            <div style={{ marginTop: 24, fontSize: 26, color: '#a1a1aa', maxWidth: 900, lineHeight: 1.4 }}>
              {post.description}
            </div>
          </div>
        </div>
