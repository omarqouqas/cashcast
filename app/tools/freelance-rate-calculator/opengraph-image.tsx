    ...
    (
      ...
      >
        ...
        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 26, fontSize: 74, fontWeight: 700, letterSpacing: -1 }}>What Should You Charge?</div>

          <div style={{ marginTop: 18, fontSize: 30, color: '#a1a1aa', maxWidth: 920, lineHeight: 1.35 }}>
            Calculate your freelance hourly rate based on income goals and real expenses.
          </div>
        </div>
