    ...
    (
      ...
      >
        ...
        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 18, fontSize: 30, color: '#a1a1aa', maxWidth: 900, lineHeight: 1.35 }}>
            A forward-looking cash flow projection to see your lowest point before you buy.
          </div>
        </div>
