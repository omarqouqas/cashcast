    ...
    (
      ...
      >
        ...
        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 26, fontSize: 74, fontWeight: 700, letterSpacing: -1 }}>When Will You Get Paid?</div>

          <div style={{ marginTop: 18, fontSize: 30, color: '#a1a1aa', maxWidth: 980, lineHeight: 1.35 }}>
            Calculate expected payment dates from Net-30, Net-60, or any terms. Adjusted for weekends.
          </div>
        </div>
