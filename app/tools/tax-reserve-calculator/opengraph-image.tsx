      ...
      >
        ...
        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column' }}>
          ...
          >
            ...
            />
            Free Tax Calculator • US & Canada
          </div>

          <div style={{ marginTop: 26, fontSize: 74, fontWeight: 700, letterSpacing: -1 }}>
            How Much to Set Aside?
          </div>

          <div style={{ marginTop: 18, fontSize: 30, color: '#a1a1aa', maxWidth: 920, lineHeight: 1.35 }}>
            Calculate your tax reserve and see your true Safe to Spend after taxes.
          </div>
        </div>
