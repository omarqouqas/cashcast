...
import { Clock, FileText, DollarSign, Lock, Timer } from 'lucide-react';
...
const FEATURES = [
  {
    ...
    description: 'Start tracking with a single click',
  },
  {
    icon: Clock,
    title: 'Manual Time Entry',
    description: 'Log hours for any project or client',
  },
  {
    icon: FileText,
  ...
  },
  {
    ...
    description: 'Track earnings per project and client',
  },
] as const;

export function TimeTrackingUpgradePrompt() {
      ...
      <div className="relative max-w-2xl mx-auto text-center space-y-8">
        ...
        <div className="space-y-3">
          <h1 className="text-3xl md:text-4xl font-bold text-white">
            Track Time, Get Paid Faster
          </h1>
          <p className="text-lg text-zinc-400 max-w-lg mx-auto">
            Track your billable hours, create invoices from time entries, and see your earnings
            flow directly into your cash flow forecast.
          </p>
        </div>
        ...
        <p className="text-sm text-zinc-500">
          Join 100+ freelancers tracking their time
        </p>
