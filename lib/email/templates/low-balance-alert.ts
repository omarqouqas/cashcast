                ...
                <table role="presentation" cellpadding="0" cellspacing="0">
                  <tr>
                    <td bgcolor="#18181b" style="border-radius:10px;">
                      <a href="https://cashcast.money/dashboard/calendar?utm_source=low_balance_alert&utm_medium=email" target="_blank" rel="noreferrer"
            ...
            <tr>
              <td style="padding:16px 24px;border-top:1px solid #f4f4f5;background-color:#fafafa;">
                <div style="font-family:Inter,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;font-size:12px;color:#71717a;">
                  ...
                  <p style="margin:0;">
                    <a href="https://cashcast.money" style="color:#0f766e;text-decoration:none;">Cashcast</a> — See your money ahead of time
                  </p>
                </div>
              </td>
            </tr>
